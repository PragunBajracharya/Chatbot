...
def encoder_rnn(rnn_inputs, rnn_size, num_layers, keep_prob, sequence_length):
    ...
    encoder_output, encoder_state = tf.nn.bidirectional_dynamic_rnn(cell_fw = encoder_cell, cell_bw = encoder_cell, sequence_length = sequence_length, 
